...
COS_API_KEY_ID="qRsLD_yUO7M_mQOMXmIhdbxft89Ar2EjEAObPWQkEHgc"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/4a5da9f17bbc4473967bebd0d5a620a7:ed89e2c5-c141-4838-abf3-09b31156d862::"
...
@app.route('/')
def index():
    files = get_bucket_contents('nutritionbucket')
